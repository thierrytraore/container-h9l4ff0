...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-h9l4ff0.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-h9l4ff0.containers.anotherwebservice.com/
...
```
git clone git@github.com:thierrytraore/container-h9l4ff0.git
cd container-h9l4ff0
```
...
```
docker attach container-h9l4ff0
```
